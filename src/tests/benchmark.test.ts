...
async function benchmark<T>(func: (...args: any[]) => Promise<T>, ...args: any[]): Promise<number> {
...
async function averageBenchmark<T>(func: (...args: any[]) => Promise<T>, runs: number, ...args: any[]): Promise<number> {
