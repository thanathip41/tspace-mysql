...
> extends AbstractModel {
  ...
  >(
    ...
    return Repository<M>(this as any).toArray(column,options);
  }
  ...
  */
  ...
  public orWhere<K extends T.ColumnKeys<this>>(
    ...
    if (value === null) {
      return this.orWhereNull(column as any);
    }
  ...
  >(): this {
    ...
    const schema = Reflect.getMetadata(REFLECT_META.SCHEMA, this) || null;
